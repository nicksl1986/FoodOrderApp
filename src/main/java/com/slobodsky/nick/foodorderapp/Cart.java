...
import com.slobodsky.nick.foodorderapp.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTotalPrice = findViewById(R.id.idTotal);
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Request request = new Request(Common.currentUser.getPhone(),
                        Common.currentUser.getName(), edtAddress.getText().toString(),
                ...
                Toast.makeText(Cart.this, "Thank you, Order placed.",
    ...
    private void loadListFood()
    {
        ...
        for (Order order:carts)
            ...
            total += (Double.parseDouble(order.getPrice())) * (Double.parseDouble(order.
                    getQuantity()));
