package com.slobodsky.nick.foodorderapp.Database;
...
public class Database extends SQLiteAssetHelper {
    ...
    public void addToCart(Order order)
    {
        ...
        String query = String.format("INSERT INTO OrderDetails(ProductID, ProductName, Quantity, " +
                "Price) VALUES('%s', '%s', '%s', '%s');", order.getProductID(),
